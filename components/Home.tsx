...
export const Home: React.FC<HomeProps> = ({ onNavigate, onViewDetail, onAddToCart }) => {
    
    const spotlightProduct = PRODUCTS.find(p => p.id === 2) || PRODUCTS[1]; // Super Collagen Mask
    ...
    return (
        <div className="animate-fade-in overflow-hidden ">
            ...
            {/* "Shop by Concern" - Bioderma Influence (Solution Oriented) */}
            ...
            {/* "Trending Now" - Essence Influence (Fun, Visual, Pink Background) */}
            ...
            {/* Scientific/Ingredient Spotlight - Bioderma Style (Clean, White) */}
                ...
                <div className="flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="w-full md:w-1/2 space-y-8">
                        ...
                        <button 
                            ...
                            className="mt-8 border-b-2 border-sole-terra text-sole-terra font-bold pb-1 hover:text-[#d06e2b] hover:border-[#d06e2b] transition-colors"
                        >
                    ...
                    <div className="bg-white rounded-[3rem] p-8 md:p-12 shadow-xl shadow-sole-pink/10 flex flex-col md:flex-row items-center gap-12 border border-white/50 backdrop-blur-sm">
                        <div className="w-full md:w-1/2 order-2 md:order-1 space-y-6">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 pt-4">
                                ...
                                <button 
                                    onClick={() => onViewDetail(spotlightProduct)}
