          ...
          <div className="absolute inset-0 bg-black/20 flex items-end p-12">
            <div className="text-white">
              ...
              <p className="text-white/90 text-lg">
                {isRegistering 
                  ? "Disfruta de ofertas exclusivas, seguimiento de pedidos y consejos personalizados." 
                  : "Accede a tu historial de compras y gestiona tu rutina de belleza."}
              </p>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {!isRegistering && (
                <div className="text-right">
                  <a href="#" className="text-sm text-sole-terra font-medium hover:underline">¿Olvidaste tu contraseña?</a>
                </div>
              )}
