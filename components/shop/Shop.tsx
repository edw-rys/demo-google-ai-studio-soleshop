...
import { Filter, ChevronDown, Search, SlidersHorizontal, Home } from 'lucide-react';
...
export const Shop: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-sole-bg animate-fade-in bg-white">
      <Helmet>
        <title>Tienda | Sole Skin & Beauty</title>
        <meta name="description" content="Explora nuestra colección completa de productos faciales, serums, mascarillas y tratamientos para una piel radiante." />
      </Helmet>
                        ...
                        {totalPages > 1 && (
                            <div className="mt-12 flex justify-center gap-2">
                                <button 
                                    ...
                                    className="w-10 h-10 flex items-center justify-center rounded-full bg-white border border-gray-200 text-gray-600 hover:border-sole-terra hover:text-sole-terra disabled:opacity-50"
                                >
                                ...
                                {[...Array(totalPages)].map((_, i) => (
                                    <button
                                        ...
                                        className={`w-10 h-10 flex items-center justify-center rounded-full font-bold text-sm transition-all ${
                                            currentPage === i + 1
                                                ? 'bg-sole-terra text-white shadow-lg'
                                                : 'bg-white border border-gray-200 text-gray-600 hover:border-sole-terra'
                                        }`}
                                    >
                                        {i + 1}
                                    </button>
