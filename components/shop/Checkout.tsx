  ...
  if (cart.length === 0 && step === 'form') {
      return (
          <div className="min-h-screen flex items-center justify-center flex-col gap-4">
              ...
              <button onClick={() => navigate('/shop')} className="text-sole-terra font-bold hover:underline">Ir a la tienda</button>
          </div>
      );
  }
        ...
        <div className="lg:order-1">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
               <button type="button" onClick={() => navigate(-1)} className="w-full md:w-auto px-8 py-4 border border-gray-300 text-gray-700 font-bold rounded-full hover:bg-gray-50 transition-colors">
                 Volver
               </button>
