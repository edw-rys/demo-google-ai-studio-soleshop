      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center mb-32">
             <div className="space-y-6">
                 ...
                 <div className="w-20 h-1 bg-sole-terra rounded-full"></div>
             ...
             <div className="relative">
                 <div className="absolute inset-0 bg-sole-pink rounded-3xl rotate-6 transform"></div>
                 <img 
        ...
        <div className="mb-32">
            <div className="text-center max-w-2xl mx-auto mb-16">
                <h2 className="font-serif text-4xl font-bold text-gray-900 mb-4">Nuestros Valores</h2>
        ...
        {/* Quote Parallax-ish */}
        <div className="relative bg-sole-terra rounded-[3rem] overflow-hidden text-center py-24 px-8 text-white mb-24">
             <div className="absolute inset-0 opacity-10 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')]"></div>
             <div className="relative z-10 max-w-3xl mx-auto">
                <p className="font-serif text-3xl md:text-5xl italic leading-snug mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 h-96">
            ...
            <img src="https://images.unsplash.com/photo-1620916297397-a4a5402a3c6c?auto=format&fit=crop&w=400&q=80" className="w-full h-full object-cover rounded-2xl hover:opacity-90 transition-opacity translate-y-8" />
            ...
            <img src="https://images.unsplash.com/photo-1596462502278-27bfdd403348?auto=format&fit=crop&w=400&q=80" className="w-full h-full object-cover rounded-2xl hover:opacity-90 transition-opacity translate-y-8" />
        </div>
