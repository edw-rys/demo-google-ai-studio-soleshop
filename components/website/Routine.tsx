...
import { Droplets, Sun, Moon, Sparkles, Plus } from 'lucide-react';
...
export const Routine: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-sole-bg pb-20 animate-fade-in">
      <Helmet>
        <title>Rutina Facial | Sole Skin & Beauty</title>
        <meta name="description" content="Descubre nuestra guía de 4 pasos para una piel perfecta. Limpieza, tonificación, tratamiento y nutrición." />
      </Helmet>
