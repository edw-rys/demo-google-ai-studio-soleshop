...
export const About: React.FC = () => {
  return (
    <div className="min-h-screen bg-sole-bg animate-fade-in">
      <Helmet>
        <title>Nosotros | Sole Skin & Beauty</title>
        <meta name="description" content="Conoce la historia detrás de Sole Skin & Beauty. Skincare consciente, natural y eficaz para mujeres modernas." />
      </Helmet>
